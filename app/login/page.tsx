    ...
    <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'radial-gradient(120% 80% at 50% -10%, #102d2f 0%, #07151a 60%)', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <div style={{ fontSize: '14px', color: '#8aa39d', marginTop: '8px' }}>Sign in to track your collection</div>
        </div>
        ...
        <div style={{ background: '#0f2a2c', border: '1px solid #1d4441', borderRadius: '16px', padding: '32px' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '16px', fontSize: '13px' }}>
            <a href="/forgot-password" style={{ color: '#6f8a85', textDecoration: 'none' }}>Forgot password?</a>
          </div>
          <div style={{ textAlign: 'center', marginTop: '10px', fontSize: '13px', color: '#6f8a85' }}>
            No account?{' '}
            <a href="/signup" style={{ color: '#e8b14a', textDecoration: 'none', fontWeight: 600 }}>Create one &rarr;</a>
          </div>
        </div>
      </div>
    </div>
